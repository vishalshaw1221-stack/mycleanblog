...
<span class="underline">**Mean:**</span>
...
<span class="underline">**Median:**</span>
...
## <span class="underline">**Now To Calculate Mean:**</span>
...
<span class="underline">**Assumed Mean Method:**</span>
...
<span id="tab:table3" label="tab:table3">\[tab:table3\]</span>
...
<span class="underline">**Step Deviation Method:**</span> Now if you see \(d_i\) in Table [1](#tab:table3), \(d_i\) is multiple of 10. If we divide each \(d_i\) by 10 then find mean of new quantity \(u_i=\frac{d_i}{10}\)
...
which is exactly \(\bar{d}\) we found earlier. So it makes things even easier. The concept behind it is simple, it doesn’t require a formal proof because taking common of a product term is easy. In Equation [\[eq:meanex\]](#eq:meanex) just multiply by any number, and it will easily go inside in each class mark. And finally after finding \(d_i\) just add assumed mean \(a\) to get final mean \(\bar{X}\).
...
## <span class="underline">**How to calculate Median:**</span>
...
<span id="tab:freqdistformedian" label="tab:freqdistformedian">\[tab:freqdistformedian\]</span>
...
Note that, CF of last class interval is sum of all frequencies thus in Table [2](#tab:freqdistformedian) last CF say \(n = 13\).
